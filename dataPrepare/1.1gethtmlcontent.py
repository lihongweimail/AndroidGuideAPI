...
fcsv=open(data_path+'/androidAPIinput.csv','w', encoding='utf-8')
...
filenamefile=open(data_path+'/filenamelist.csv','w',encoding='utf-8')
...
filesNamelist = []
filesNamelist = getfilenamelist(mypath)
